    ...
    <li>
      <div id="form-right">
        ...
        <ul>
          ...
          <li><input id="keywords" type="text" ${art.keywords} /></li>
        </ul>
        <ul>
          <li data-width="10">简介：</li>
          <li><textarea id="desc" rows="6">${art.description}</textarea></li>
        </ul>
        <ul>
          <li data-width="10">内容：</li>
          <li><textarea id="content">${art.content}</textarea></li>
        </ul>
        <ul>
          <li></li>
          <li data-width="10"><a id="btn-preview">预览</a></li>
          <li data-width="1"></li>
          <li data-width="10"><a id="btn">确定修改</a></li>
        </ul>
      </div>
    </li>
  </ul>
